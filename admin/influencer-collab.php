...
<head>
  ...
  <title>
    Influencer Collaborated with List
  </title>
  <!--     Fonts and icons     -->
...
<body class="g-sidenav-show">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li style="color:#fff;" class="nav-item d-flex align-items-center">
    ...
    <!-- <div class="container-fluid py-4"> -->
      <!-- <div class="row" style="color:#000;font-family:cursive;">
        <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
          <div class="card" >
            ...
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-white text-sm font-weight-bolder">+2 </span>Influencers this month</p>
            </div>
          </div>
        </div>
        <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-white text-sm font-weight-bolder">+3 </span>more on 8 Dec 2023</p>
            </div>
          </div>
        </div>
        <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-white text-sm font-weight-bolder">+2%</span> more on 8 Dec 2023</p>
            </div>
          </div>
        </div>
            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h3 style="font-family:cursive;color:#000;">Influencer We have Woked With</h3>
                
                </div>
                <div class="col-lg-6 col-5 my-auto text-end">
                <a href="./addinfluencer.php"><button class="btn" style="background-color:#000;color:#fff">Add New Influencer </button></a>
                ...
                <table class="table align-items-center mb-0" style="color:#000;font-family:cursive;">
                  ...
                  <tr>
                    <td class="align-middle text-center text-sm" style="border: 2px solid black;">
                        <span class="text-xs font-weight-bold"><?php echo $row["0"]?></span>
                      </td>
                    <td class="align-middle text-center text-sm" style="border: 2px solid black;">
                        <span class="text-xs font-weight-bold"><?php echo $row["1"]?></span>
                      </td>
                      <td class="align-middle text-center text-sm" style="border: 2px solid black;">
                        <span class="text-xs font-weight-bold"> <a href="mailto: <?php $row["2"]; ?>"><?php echo $row["ciemail"] ?></a></span>
                      </td>
                      <td class="align-middle text-center text-sm" style="border: 2px solid black;">
                      ...
                      <td class="align-middle text-center text-sm" style="border: 2px solid black;">
                        ...
                        <img src='../image/collabrated-influencers/<?php echo $row["6"]; ?>' width="100px">
                      </td>
                      ...
                      <td class="align-middle text-center text-sm" style="border: 2px solid black;">
                        <span class="text-xs font-weight-bold"><?php echo $row["15"] ?></span>
                      </td>
                      <td class="align-middle text-center text-sm" style="border: 2px solid black;">
                        <span class="text-xs font-weight-bold"> <?php echo $row["16"] ?></span>
                      </td>
                      <td class="align-middle text-center text-sm" style="border: 2px solid black;">
                      <button class="btn btn-warning" style="color:#000;"><a href="<?php echo $row["17"] ?>">Report</a></button>    
                    </td>
                      <td class="align-middle text-center text-sm" style="border: 2px solid black;">
