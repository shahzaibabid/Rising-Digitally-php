  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active" href="../admin/phone-slider.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
<!--           
  ...
  <form id="contact" action="phone-slider-form.php" method="post" encytype="multipart/form-data" style="background-color:#58BDB3;color:#000;font-family:cursive;">
    ...
    <fieldset>
      <input placeholder="Enter Influencer Name" type="text" name="iname" tabindex="1" required autofocus>
    </fieldset>
    <fieldset>
